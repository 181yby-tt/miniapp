...
const studentItems = [
  ['/courses', '选课', 'courses'], ['/enrollments', '我的课程', 'check'], ['/schedule', '课表', 'calendar'], ['/profile', '我的', 'user'],
];
const adminDailyItems = [
  ['/admin', '工作台', 'dashboard'], ['/admin/students', '学生管理', 'users'], ['/admin/courses', '课程管理', 'courses'], ['/admin/enrollments', '报名管理', 'check'], ['/admin/schedule', '排课管理', 'calendar'],
];
const adminSystemItems = [
  ['/admin/resources', '排课设置', 'database'], ['/admin/groups', '教学组设置', 'clipboard'], ['/admin/settings', '规则与记录', 'settings'],
];
